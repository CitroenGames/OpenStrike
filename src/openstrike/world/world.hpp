...
struct WorldProp
{
    ...
    std::uint16_t min_dx_level = 0;
    std::uint16_t max_dx_level = 0;
    std::uint8_t min_cpu_level = 0;
    std::uint8_t max_cpu_level = 0;
    std::uint8_t min_gpu_level = 0;
    std::uint8_t max_gpu_level = 0;
    bool disable_x360 = false;
